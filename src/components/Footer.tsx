        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/" className="text-gray-300 hover:text-luxury-green transition-colors">Home</Link>
              </li>
              <li>
                <Link to="/#properties" className="text-gray-300 hover:text-luxury-green transition-colors">Properties</Link>
              </li>
              <li>
                <Link to="/#amenities" className="text-gray-300 hover:text-luxury-green transition-colors">Amenities</Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="font-serif text-lg font-semibold text-white mb-6">Resources</h3>
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-gray-300 hover:text-luxury-gold transition-colors">FAQ</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-luxury-gold transition-colors">Neighborhood Guide</a>
              </li>
              <li>
          ...
          <div>
            <h3 className="font-serif text-lg font-semibold text-white mb-6">Office</h3>
