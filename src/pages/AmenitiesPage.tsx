...
// Creating a Card component specifically for this page
const AmenityPageCard = ({ icon, title }) => (
  <div className="card-gradient p-6 rounded-lg transition-all duration-300 hover:shadow-elegant border-l-4 border-luxury-green flex flex-col items-center justify-center text-center h-40">
...
const AmenitiesPage = () => {
  ...
  return (
    <div className="min-h-screen gradient-flow-middle py-20">
